...
<form method="GET" action="{{ route('transactions.index') }}"
    ...
    <div class="min-w-[130px]">
        ...
        <select name="type" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-600">
    ...
    <div class="min-w-[150px]">
        ...
        <select name="category_id" class="w-full border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-green-600">
    ...
    <table class="w-full text-sm">
        ...
        @forelse($transactions as $t)
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="p-4 text-gray-500 text-xs max-w-[200px] truncate">
                    {{ $t->description ?? '-' }}
                </td>
...
<div id="modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    ...
    <div class="bg-white w-96 rounded-xl shadow-lg p-6 relative">
        ...
        <div class="space-y-2 text-sm text-gray-700">
            ...
            <p><b>Deskripsi:</b> <span id="m-desc" class="text-gray-500">-</span></p>
